...
namespace _1.Scripts.Grabbables
{
    ...
    public class NetworkWeaponGrabbable : NetworkBehaviour
    {
        ...
        public Quaternion grabRotOffset;
        ...
        {
            if (IsGrabbed || status != Status.NotGrabbed || isTakingAuthority)
            {
                return;
            }

            onWillGrab?.Invoke(newGrabber);

            // --- SNAP TO GRABBER CENTER + OFFSET ---
            localPositionOffsetWhileTakingAuthority = grabPosOffset;
            localRotationOffsetWhileTakingAuthority = grabRotOffset;
        ...
        bool TryDetectGrabberChange(ChangeDetector changeDetector, out NetworkHandColliderGrabber previousGrabber,
            out NetworkHandColliderGrabber currentGrabber)
        {
        ...
        void ExtrapolateWhileTakingAuthority()
        {
            ...
            Follow(followedTransform: grabberWhileTakingAuthority.hand.transform, localPositionOffsetWhileTakingAuthority,
                localRotationOffsetWhileTakingAuthority);
        }
